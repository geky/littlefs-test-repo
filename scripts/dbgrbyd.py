...
TAG_MAGIC       = 0x0231    #   v--- --1- +-11 --rr
TAG_VERSION     = 0x0234    #   v--- --1- +-11 -1--
TAG_RCOMPAT     = 0x0235    #   v--- --1- +-11 -1-1
TAG_WCOMPAT     = 0x0236    #   v--- --1- +-11 -11-
TAG_OCOMPAT     = 0x0237    #   v--- --1- +-11 -111
TAG_GEOMETRY    = 0x0238    #   v--- --1- +-11 1---
TAG_NAMELIMIT   = 0x0239    #   v--- --1- +-11 1--1
TAG_FILELIMIT   = 0x023a    #   v--- --1- +-11 1-1-
TAG_GDELTA      = 0x0300    ##  v--- --11 +ttt tttt
TAG_GRMDELTA    = 0x0330    #   v--- --11 +-11 --++
TAG_GBMAPDELTA  = 0x0334    #   v--- --11 +-11 -1rr
