...
gc_STEPLOOKAHEAD \
                = 0x00000200  # i-  Repopulate lookahead buffer
gc_STEPPREERASE = 0x00000400  # i-  Try to pre-erase free blocks
gc_STEPCOMPACTMETA \
                = 0x00000800  # i-  Compact metadata logs
gc_STEPCKMETA   = 0x00001000  # i-  Check metadata checksums
gc_STEPCKDATA   = 0x00002000  # i-  Check metadata + data checksums
