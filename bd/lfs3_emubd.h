...
// a readonly disk (ERASENOOP), ECC failures (PROGCORRUPT, READQUASIDAMAGED),
...
typedef struct lfs3_emubd {
    ...
    lfs3_emubd_io_t wreads;
    lfs3_emubd_io_t wprogs;
    lfs3_emubd_io_t werases;
