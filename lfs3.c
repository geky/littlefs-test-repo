...
static int lfs3_bshrub_commitroot_(lfs3_t *lfs3, lfs3_bshrub_t *bshrub,
    ...
    // in-flight!
    int err = lfs3_mdir_commit_(lfs3, &bshrub->h.mdir, (const lfs3_rattr_t[]){
            LFS3_RATTR(LFS3_tag_SHRUBCOMMIT, 0, 3),
    ...
    for (lfs3_handle_t *h = lfs3->handles; h; h = h->next) {
        if (lfs3_o_type(h->flags) == LFS3_TYPE_REG
                && h->mdir.mid == bshrub->h.mdir.mid
                && lfs3_bshrub_isbshrub((lfs3_bshrub_t*)h)) {
            ((lfs3_bshrub_t*)h)->b.eoff = estimate;
    ...
    LFS3_ASSERT(bshrub->b.eoff == (lfs3_size_t)estimate);
...
static int lfs3_mdir_compact_(lfs3_t *lfs3, lfs3_mdir_t *mdir) {
    ...
    lfs3_mdir_claim(mdir);
    return lfs3_mdir_commit_(lfs3, mdir, (const lfs3_rattr_t[]){
            LFS3_RATTR_NULL});
}
#endif
...
static lfs3_sblock_t lfs3_allocclaim(lfs3_t *lfs3, lfs3_mdir_t *mdir,
    ...
    if (lfs3_ecksum_isecksum(&ecksum_)) {
        ...
        int err = lfs3_mdir_commit_(lfs3, mdir, (const lfs3_rattr_t[]){
                LFS3_RATTR_NULL});
        if (err) {
            return err;
        }
    ...
    if (lfs3_o_needssync(file->b.h.flags)) {
        ...
        if (lfs3_o_needsflush(file->b.h.flags)) {
            ...
            if (file->cache.size > 0) {
                ...
                *r++ = LFS3_RATTR(LFS3_tag_SHRUBCOMMIT, 0, 3);
